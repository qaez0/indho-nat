...
export const invitationCard = [
  ...
  {
    text: "آج سلاٹس نے کمال کر دیا! ایک اسپن میں اتنی بڑی جیت ملی کہ اب تک یقین نہیں ہو رہا! 11ic پر ہر کسی کا دن بنتا ہے! آج تمہارا ہو سکتا ہے!",
    src: imageHandler(
      "/cdn-cgi/imagedelivery/SViyH5iSEWrJ3_F3ZK6HYg/c11bet-invitefriends1-webp/210 "
    ),
  },
  {
    text: "میں صرف ٹائم پاس کے لیے کھیل رہا تھا… اور سلاٹ میں جیک پاٹ لگ گیا! 💰11ic والوں نے سچ میں پیسے دیے! اب تمہاری باری ہے جیتنے کی!",
    src: imageHandler(
      "/cdn-cgi/imagedelivery/SViyH5iSEWrJ3_F3ZK6HYg/c11bet-invitefriends2-webp/210 "
    ),
  },
  {
    text: "بس اتنا چاہیے کہ تم اس پر کلک کرو، رجسٹر کرو، اور میری طرح مفت 1000 بونس لے لو!",
    src: imageHandler(
      "/cdn-cgi/imagedelivery/SViyH5iSEWrJ3_F3ZK6HYg/c11bet-invitefriends3-webp/210 "
    ),
  },
  {
    text: "100% ریئل منی ایپ، وہ بھی 1000 روپے کے مفت بونس کے ساتھ صرف محدود وقت کے لیے، میں لے چکا ہوں، تم بھی لو!",
    src: imageHandler(
      "/cdn-cgi/imagedelivery/SViyH5iSEWrJ3_F3ZK6HYg/c11bet-invitefriends4-webp/210 "
    ),
  },
